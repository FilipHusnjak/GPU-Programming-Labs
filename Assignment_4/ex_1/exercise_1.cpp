...
const char *my_kernel = "__kernel\n"
                        ...
                        "   int idx_z = get_group_id(2) * get_local_size(2) + get_local_id(2);"
...
int main() {
    ...
    size_t work_items_num[] = {8, 8, 4};
    size_t workgroup_size[] = {4, 4, 4};

    // kernel launch
    err = clEnqueueNDRangeKernel(cmd_queue, kernel, 3, nullptr, work_items_num, workgroup_size, 0, nullptr, nullptr);
